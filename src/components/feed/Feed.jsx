...
const Feed = () => {
	...
	return (
		<div
			className='flex w-full bg-slate-100 transition duration-300 dark:bg-feed-background-d'
			style={{
		...
		>
			...
			*/}
			<main className='mx-auto flex min-h-full max-w-feed-width flex-grow overflow-y-auto overflow-x-hidden p-6'>
				<Outlet />
			</main>
		</div>
	)
