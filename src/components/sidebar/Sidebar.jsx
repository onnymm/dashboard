...
const Sidebar = ({ isOpen }) => {
	return (
		<aside
			className={`${!isOpen ? '-translate-x-72' : ''} z-10 fixed transition duration-500 flex flex-col h-screen w-72 select-none bg-sidebar-background dark:bg-sidebar-background-d`}
		>
