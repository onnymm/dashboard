export const FallbackContentList = ({ numberOfElements = 0 }) => {
	return (
		<div className='flex max-h-80 flex-col overflow-hidden rounded-md'>
			<div className='transition-color sticky top-0 h-11 bg-white text-sm duration-300 dark:bg-navbar-icons-background-d'></div>
			<div className='flex flex-col gap-2 overflow-y-auto bg-slate-100 duration-300 dark:bg-darkmode-switch-background-d'>
				...
				{[...Array(numberOfElements + 1)].map((_, index) => (
					<div key={index} className='flex w-full items-center gap-4 p-4'>
