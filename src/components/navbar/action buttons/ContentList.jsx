...
const ContentList = ({ name, data, contains }) => {
	return (
		<div className='absolute -right-0 top-0 flex max-h-80 w-54 flex-col overflow-hidden rounded-md shadow-back sm:w-80'>
			...
			<div className='transition-color overflow-y-auto bg-slate-100 duration-300 dark:divide-navbar-icons-background-d dark:bg-darkmode-switch-background-d'>
				{/* Generador de lista */}
				<List
					Contains={contains}
					data={data}
