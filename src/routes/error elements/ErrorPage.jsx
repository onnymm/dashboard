...
const ErrorPage = () => {
	...
	return (
		<div className='flex h-full flex-grow flex-col items-center justify-center gap-2 bg-slate-100 py-10 opacity-90 transition duration-300 dark:bg-feed-background-d dark:text-white dark:opacity-80'>
