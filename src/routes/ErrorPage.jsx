...
const ErrorPage = () => {
	...
	return (
		<div className='duration-dark flex h-full flex-grow flex-col items-center justify-center gap-2 bg-slate-100 py-10 transition-colors dark:bg-feed-background-d dark:text-white'>
			...
			{!lowercasedPath == '' && (
				...
				<Link
					className='flex gap-2 rounded-md bg-blue-600 px-4 py-2 text-white shadow transition duration-300 hover:-translate-y-1 hover:bg-blue-500'
					style={{
